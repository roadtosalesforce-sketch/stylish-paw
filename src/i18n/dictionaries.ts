...
export const dictionaries = {
  en: {
    ...
    product: {
      ...
      shippingReturns: "Shipping & returns", shippingText: "Delivery times and the complete returns policy will be shown here once configured in Shop Settings.",
    },
    sizeGuide: {
    ...
    cart: {
      ...
      summary: "Order Summary", subtotal: "Subtotal", shipping: "Shipping", free: "Free", total: "Total", freeShipping: "Add {amount} more for free shipping!",
    ...
    checkout: {
      ...
      changed: "A product in your cart has changed. Please refresh and try again.", failed: "Checkout could not be started. Please try again.", freeShipping: "Free shipping", standardShipping: "Standard shipping",
    },
  ...
  pl: {
    ...
    product: {
      ...
      shippingReturns: "Dostawa i zwroty", shippingText: "Czas dostawy i pełne zasady zwrotów będą tutaj widoczne po skonfigurowaniu ich w ustawieniach sklepu.",
    },
    sizeGuide: {
    ...
    cart: {
      ...
      summary: "Podsumowanie zamówienia", subtotal: "Suma częściowa", shipping: "Dostawa", free: "Bezpłatna", total: "Razem", freeShipping: "Dodaj jeszcze {amount}, aby otrzymać darmową dostawę!",
    ...
    checkout: {
      ...
      changed: "Produkt w koszyku uległ zmianie. Odśwież stronę i spróbuj ponownie.", failed: "Nie udało się rozpocząć płatności. Spróbuj ponownie.", freeShipping: "Darmowa dostawa", standardShipping: "Dostawa standardowa",
    },
