...
export const pageType = defineType({
  ...
  groups: [{name:"content",title:"Content",default:true},{name:"polish",title:"Polish / Polski"},{name:"seo",title:"SEO"}],
  fields: [
    defineField({name:"title",title:"Page title",type:"string",group:"content",validation:r=>r.required()}),
    defineField({name:"titlePl",title:"Page title (Polish)",type:"string",group:"polish"}),
    ...
    defineField({name:"seoTitlePl",title:"SEO title (Polish)",type:"string",group:"seo",validation:r=>r.max(60)}),
    defineField({name:"seoDescriptionPl",title:"SEO description (Polish)",type:"text",rows:3,group:"seo",validation:r=>r.max(160)}),
  ],
